...
- **Copper Chest Rows** — a single copper chest holds 4 rows (36 slots) and a double copper chest holds 8 rows (72 slots) via a custom in-game screen. On by default; toggle it in the config screen. Size changes take effect on world reload.
