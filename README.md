...
| **Cobblestone → Blackstone** | always | Blasting cobblestone in a **blast furnace** yields blackstone (a regular furnace still makes stone). Makes blackstone renewable. |
